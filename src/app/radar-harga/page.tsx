...
export default async function RadarHargaPage() {
  // Pre-fetch initial benchmark result on server for complete SEO crawlers
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Bagaimana cara kerja Radar Harga Marketplace?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Radar Harga mengumpulkan katalog penawaran harga dasar dari Shopee, Tokopedia, TikTok Shop, dan Lazada secara terpadu dan mengurutkannya dari yang paling hemat.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Setiap marketplace memiliki struktur biaya komisi admin, program subsidi gratis ongkir, dan program promosi yang berbeda-beda, sehingga penjual sering menyesuaikan harga jual untuk menjaga margin keuntungan.',
          },
        },
      ],
    },
    ...
    <>
      ...
      <div className="bg-canvas py-10 sm:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white px-3 py-1 shadow-subtle">
