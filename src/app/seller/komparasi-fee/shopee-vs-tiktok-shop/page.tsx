...
export const metadata = constructMetadata({
  ...
  path: '/seller/komparasi-fee/shopee-vs-tiktok-shop',
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'Shopee vs TikTok Shop', url: 'https://kalkulatormarketplace.id/seller/komparasi-fee/shopee-vs-tiktok-shop' },
        ]}
      />
