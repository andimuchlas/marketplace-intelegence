...
export const metadata = constructMetadata({
  ...
  path: '/tiktok-shop-profit-calculator',
  ...
  return (
    <>
      <SoftwareApplicationJsonLd
        ...
        url="https://kalkulatormarketplace.id/tiktok-shop-profit-calculator"
      />
      <BreadcrumbJsonLd
        items={[
          { name: 'Beranda', url: 'https://kalkulatormarketplace.id' },
          { name: 'TikTok Shop', url: 'https://kalkulatormarketplace.id/tiktok-shop-fee' },
          { name: 'Kalkulator Profit', url: 'https://kalkulatormarketplace.id/tiktok-shop-profit-calculator' },
        ]}
      />
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <section className="my-10 rounded-2xl border border-stone-200 bg-white p-6 shadow-card">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3 text-xs">
            ...
            <Link
              href="/compare/tokopedia-vs-tiktok-shop"
              className="flex items-center justify-between rounded-xl border border-stone-200 p-3 hover:border-stone-400 hover:bg-stone-50"
            >
